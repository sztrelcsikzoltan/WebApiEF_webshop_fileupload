    ...
    public class WebshopService
    {
        ...
        */
        ...
        public string AddCustomer(DTO_CustomerNoId dTO_CustomerNoId)
        {
            ...
            if (dTO_CustomerNoId.Email.Length < 4 || dTO_CustomerNoId.Email.Contains("@") == false || dTO_CustomerNoId.Email.Contains(".") == false || dTO_CustomerNoId.Email.LastIndexOf("." ) - 2 < dTO_CustomerNoId.Email.LastIndexOf("@"))  { return $"Please enter a valid e-mail address!"; }
